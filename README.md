...
## Version
- [[0.3.0](https://github.com/js4jiang5/Sesame2MQTT/tree/0.3.0)] (recommended，need to use [latest sesame2mqtt.yaml](https://github.com/js4jiang5/Sesame2MQTT/blob/0.3.0/sesame2mqtt.yaml)) <br>
...
- [[0.2.0](https://github.com/js4jiang5/Sesame2MQTT/tree/0.2.0)] (recommended，need to use [0.2.0 sesame2mqtt.yaml](https://github.com/js4jiang5/Sesame2MQTT/blob/0.2.0/sesame2mqtt.yaml)) <br>
