...
## Version
- [[0.5.0](https://github.com/js4jiang5/Sesame2MQTT/tree/0.5.0)] (recommended，need to use [latest sesame2mqtt.yaml](https://github.com/js4jiang5/Sesame2MQTT/blob/0.5.0/sesame2mqtt.yaml)) <br>
    - Restart ESP32 to solve the problem of unexpected logout of Sesame5 or Sesame5 PRO
